 ...
 * 2017-08-10T01:16:53.018-05:00
 * Generated source version: 3.0.2
 * 
 */
@WebServiceClient(name = "CustomerOrdersService", 
                  wsdlLocation = "file:/C:/myExperiment/workspace/Soapclient/soapclient/src/main/resources/CustomerOrders.wsdl",
...
public class CustomerOrdersService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/myExperiment/workspace/Soapclient/soapclient/src/main/resources/CustomerOrders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerOrdersService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/myExperiment/workspace/Soapclient/soapclient/src/main/resources/CustomerOrders.wsdl");
        }
        WSDL_LOCATION = url;
    }
